...
<div class="lui-header">
	...
	<?php code('<link rel="stylesheet" href="/template/core/atoms/checkbox/__checkbox.css">', 'markup'); ?>
</div>

<div class="lui-section">
	<div class="lui-section__info">
		<div class="lui-section__title h4"><b>Чекбокс обычного вида</b></div>
	</div>
		...
		<div class="border-tabs__blocks tabs__blocks">
			<div class="tabs__block --js --markup is-show">
				<div class="--lui-inside-step">
					<?php include($_SERVER['DOCUMENT_ROOT'].$__PATH.'/atoms/checkbox/__checkbox--1.html') ?>
				</div>
				<br><br>
				<?php code(file_get_contents($_SERVER['DOCUMENT_ROOT'].$__PATH.'/atoms/checkbox/__checkbox--1.html'), 'markup'); ?>
			</div>
			<div class="tabs__block --js --css">
				<?php code(file_get_contents($_SERVER['DOCUMENT_ROOT'].$__PATH.'/atoms/checkbox/__checkbox.css'), 'css'); ?>  
			</div>
		</div>
	</div>
</div>
