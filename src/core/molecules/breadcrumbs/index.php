...
<div class="lui-header">
	...
	<?php code('<link rel="stylesheet" href="/template/core/molecules/breadcrumbs/__breadcrumbs.css">', 'markup'); ?>
</div>

<div class="lui-section">
	<div class="lui-section__info">
		<div class="lui-section__title h4"><b>Крошки</b></div>
		...
		<div class="border-tabs__blocks tabs__blocks">
			<div class="tabs__block --js --markup is-show">
				<div class="--lui-inside-step">
					<?php include($_SERVER['DOCUMENT_ROOT'].$__PATH.'/molecules/breadcrumbs/__breadcrumbs--1.html') ?>
				</div>
				<br><br>
				<?php code(file_get_contents($_SERVER['DOCUMENT_ROOT'].$__PATH.'/molecules/breadcrumbs/__breadcrumbs--1.html'), 'markup'); ?>
			</div>
			<div class="tabs__block --js --css">
				<?php code(file_get_contents($_SERVER['DOCUMENT_ROOT'].$__PATH.'/molecules/breadcrumbs/__breadcrumbs.css'), 'css'); ?> 
			</div>
		</div>
	</div>
</div>
