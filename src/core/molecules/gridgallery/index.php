...
<div class="lui-header">
	...
	<?php code('<link rel="stylesheet" href="/template/core/molecules/gridgallery/__gridgallery.css">', 'markup'); ?>
</div>

<div class="lui-section">
	<div class="lui-section__info">
		<div class="lui-section__title h4"><b>Демо</b></div>
	...
	<div class="lui-section__tabs border-tabs tabs">
		...
		<div class="border-tabs__blocks tabs__blocks">
			<div class="tabs__block --js --markup is-show">
				<div class="flex">
					<?php include($_SERVER['DOCUMENT_ROOT'].$__PATH.'/molecules/gridgallery/__gridgallery--1.html') ?>
				</div>
			</div>
			<div class="tabs__block --js --html">
				<?php code(file_get_contents($_SERVER['DOCUMENT_ROOT'].$__PATH.'/molecules/gridgallery/__gridgallery--1.html'), 'markup'); ?> 
			</div>
			<div class="tabs__block --js --css">
				<?php code(file_get_contents($_SERVER['DOCUMENT_ROOT'].$__PATH.'/molecules/gridgallery/__gridgallery.css'), 'css'); ?> 
			</div>
		</div>
	</div>
</div>
