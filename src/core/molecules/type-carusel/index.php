...
<div class="lui-header">
	...
	<?php code('<link rel="stylesheet" href="/template/core/molecules/type-carusel/__type-carusel.css">', 'markup'); ?>
</div>

<div class="lui-section">
	<div class="lui-section__info">
		<div class="lui-section__title h4"><b>Карусель - 1</b></div>
		<div class="lui-section__desc --p">Используется по необходимости создания карусели</div>
	</div>
	<div class="lui-section__tabs border-tabs tabs">
		...
		<div class="border-tabs__blocks tabs__blocks">
			<div class="tabs__block --js --markup is-show">
				<div class="col --12">
					<?php include($_SERVER['DOCUMENT_ROOT'].$__PATH.'/molecules/type-carusel/__type-carusel--1.html') ?>
				</div>
			</div>
			<div class="tabs__block --js --html">
				<?php code(file_get_contents($_SERVER['DOCUMENT_ROOT'].$__PATH.'/molecules/type-carusel/__type-carusel--1.html'), 'markup'); ?> 
			</div>
			<div class="tabs__block --js --css">
				<?php code(file_get_contents($_SERVER['DOCUMENT_ROOT'].$__PATH.'/molecules/type-carusel/__type-carusel.css'), 'css'); ?> 
			</div>
			<div class="tabs__block --js --scr">
				<?php code(file_get_contents($_SERVER['DOCUMENT_ROOT'].$__PATH.'/molecules/type-carusel/__type-carusel.js'), 'js'); ?> 
			</div>
		</div>
	</div>
</div>
